...
//  FTLibrary
//
//  Created by Ondrej Rafaj on 07/07/2011.
...
typedef enum {
    ...
    FTProgressViewModeIndeterminate,
    /** Progress is shown using a FTRoundProgressView. */
	FTProgressViewModeDeterminate,
	/** Shows a custom view */
	FTProgressViewModeCustomView
} FTProgressViewMode;

typedef enum {
    /** Opacity animation */
    FTProgressViewAnimationFade,
 ...
 */
@interface FTRoundProgressView : UIProgressView {}
 ...
 * The FTProgressView window spans over the entire space given to it by the initWithFrame constructor and catches all
 ...
 * - FTProgressViewModeIndeterminate - shows a UIActivityIndicatorView
 * - FTProgressViewModeDeterminate - shows a custom round progress indicator (FTRoundProgressView)
 * - FTProgressViewModeCustomView - shows an arbitrary, user specified view (@see customView)
 *
...
@interface FTProgressView : UIView {
	...
	FTProgressViewMode mode;
    FTProgressViewAnimation animationType;
	...
	id<FTProgressViewDelegate> delegate;
	NSString *labelText;
 ...
 */
+ (FTProgressView *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
...
/**
 * The UIView (i.g., a UIIMageView) to be shown when the HUD is in FTProgressViewModeCustomView.
 * For best results use a 37 by 37 pixel view (so the bounds match the build in indicator bounds). 
 */
@property (retain) UIView *customView;

/** 
 * FTProgressView operation mode. Switches between indeterminate (FTProgressViewModeIndeterminate) and determinate
 * progress (FTProgressViewModeDeterminate). The default is FTProgressViewModeIndeterminate.
 *
 * @see FTProgressViewMode
 */
@property (assign) FTProgressViewMode mode;

/**
 * The animation type that should be used when the HUD is shown and hidden. 
 *
 * @see FTProgressViewAnimation
 */
 ...
 * delegate should conform to the FTProgressViewDelegate protocol and implement the hudWasHidden method. The delegate
