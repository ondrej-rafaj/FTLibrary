...
- (UIImage *) resizedImage: (CGSize) newSize
	...
	CGRect fullRect = CGRectIntegral(CGRectMake(0, 0, newSize.width, newSize.height));

	CGFloat oldWidth = self.size.width;
	CGFloat oldHeight = self.size.height;
	CGFloat newWidth = fullRect.size.width;
	CGFloat newHeight = (oldHeight * newWidth) / oldWidth;
	if(newHeight > fullRect.size.height) {
		newWidth = (newWidth * fullRect.size.height) / newHeight;
		newHeight = fullRect.size.height;
	}
