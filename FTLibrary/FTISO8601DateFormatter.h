 ...
 */
enum {
	FTISO8601DateFormatCalendar,
	FTISO8601DateFormatOrdinal,
	FTISO8601DateFormatWeek,
};
typedef NSUInteger FTISO8601DateFormat;

//The default separator for time values. Currently, this is ':'.
extern unichar ISO8601DefaultTimeSeparatorCharacter;

@interface FTISO8601DateFormatter: NSFormatter
{
...
@property FTISO8601DateFormat format;
